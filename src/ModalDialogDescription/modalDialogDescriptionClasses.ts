...
export type ModalDialogDescriptionClassKey =
  keyof ModalDialogDescriptionClasses;
...
const modalDialogDescriptionClasses: ModalDialogDescriptionClasses =
  generateUtilityClasses("JoyModalDialogDescription", ["root"]);
