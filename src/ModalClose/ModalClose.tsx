...
const useUtilityClasses = (
  ownerState: ModalCloseProps & { focusVisible: boolean }
) => {
...
const ModalClose = React.forwardRef(function ModalClose(inProps, ref) {
  ...
  const modalDialogVariantColor = React.useContext(
    ModalDialogVariantColorContext
  );
  const color = inProps.color ?? modalDialogVariantColor?.color ?? colorProp;
  const variant =
    inProps.variant ??
    modalDialogVariantMapping[modalDialogVariantColor?.variant!] ??
    variantProp;
